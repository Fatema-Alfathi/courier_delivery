...
class _CitySelectionScreenState extends State<CitySelectionScreen> with WidgetsBindingObserver {
  CitySelectionController citySelectionController = Get.put(CitySelectionController());
                    ...
                    child: ListView(
                      ...
                      children: [
                        CustomSearchView(
                          ...
                          margin: getMargin(top: 16),
                          prefix: Container(
                            margin: getMargin(left: 20, top: 11, right: 13, bottom: 11),
                            child: CustomImageView(svgPath: ImageConstant.imgSearch),
                          ),
                          prefixConstraints: BoxConstraints(maxHeight: getVerticalSize(46)),
                        ),
                        ...
                        ListView.builder(
                          ...
                          itemCount: controller.city.length,
                          itemBuilder: (context, index) {
                            CitySelectionModel data = controller.city[index];
                            return GestureDetector(
                              onTap: () {
                                PrefUtils.setIsSignIn(false);
                                controller.setCurrentCity(index);
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    controller.currentCity == index
                                        ? CustomImageView(svgPath: ImageConstant.imgTickIcon)
                                        : SizedBox(),
                                  ],
                                ),
                              ),
